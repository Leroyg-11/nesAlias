...
// node_modules/react-flippy/dist/index.cjs.js
var require_index_cjs = __commonJS({
  "node_modules/react-flippy/dist/index.cjs.js"(exports) {
    ...
    var Flippy = React__default.forwardRef(function(_ref, ref) {
      var _isFlipped = _ref.isFlipped, className = _ref.className, flipDirection = _ref.flipDirection, style = _ref.style, children = _ref.children, flipOnHover = _ref.flipOnHover, flipOnClick = _ref.flipOnClick, onClick = _ref.onClick, onTouchStart = _ref.onTouchStart, onMouseEnter = _ref.onMouseEnter, onMouseLeave = _ref.onMouseLeave, rest = _objectWithoutProperties(_ref, ["isFlipped", "className", "flipDirection", "style", "children", "flipOnHover", "flipOnClick", "onClick", "onTouchStart", "onMouseEnter", "onMouseLeave"]);
      var simpleFlag = React.useRef({
        isTouchDevice: false
      });
      var _useState = React.useState(false), _useState2 = _slicedToArray(_useState, 2), isTouchDevice = _useState2[0], setTouchDevice = _useState2[1];
      var _useState3 = React.useState(false), _useState4 = _slicedToArray(_useState3, 2), isFlipped = _useState4[0], setFlipped = _useState4[1];
    ...
    var FlippyCard = function(_React$Component) {
      _inherits(FlippyCard2, _React$Component);
      var _super = _createSuper(FlippyCard2);
      function FlippyCard2() {
        _classCallCheck(this, FlippyCard2);
        return _super.apply(this, arguments);
      }
      _createClass(FlippyCard2, [{
        key: "render",
        value: function render() {
          var _this$props = this.props, className = _this$props.className, cardType = _this$props.cardType, style = _this$props.style, elementType = _this$props.elementType, animationDuration = _this$props.animationDuration, rest = _objectWithoutProperties(_this$props, ["className", "cardType", "style", "elementType", "animationDuration"]);
          return React__default.createElement(elementType || "div", _objectSpread$1(_objectSpread$1({
            className: "flippy-card flippy-".concat(cardType, " ").concat(className || "")
          }, rest), {}, {
            style: _objectSpread$1(_objectSpread$1({}, style || {}), {
              transitionDuration: "".concat(animationDuration / 1e3, "s")
            })
          }), this.props.children);
        }
      }]);
    ...
    var FrontSide = function FrontSide2(_ref) {
      var isFlipped = _ref.isFlipped, style = _ref.style, animationDuration = _ref.animationDuration, props = _objectWithoutProperties(_ref, ["isFlipped", "style", "animationDuration"]);
      return React__default.createElement(FlippyCard, _extends({}, props, {
        style: _objectSpread$1({}, style || {}),
        animationDuration,
        cardType: "front"
      }));
    };
    var BackSide = function BackSide2(_ref2) {
      var isFlipped = _ref2.isFlipped, style = _ref2.style, props = _objectWithoutProperties(_ref2, ["isFlipped", "style"]);
      return React__default.createElement(FlippyCard, _extends({}, props, {
        style: _objectSpread$1({}, style || {}),
        cardType: "back"
      }));
...
//# sourceMappingURL=react-flippy.js.map
